...
<div class="box">
    ...
    <div class="box__header"><i class="fas fa-hourglass-half text-warning"></i><span class="padding-x-2"><?=lang('system', 'order_pending_confirm');?></span></div>
    <div class="box__body">
    ...
    <?php if($list_order): ?>
        ...
        <div class="table-scroll">
            ...
            ?>
                    <tr>
                        <td>
                        <?php if(Auth::$data['is_ban_team'] == Team::IS_NOT_BAN): ?>
                            <button role="btn-get-order" class="btn btn--round btn--small <?=($order['status'] == Order::STATUS_PENDING_CONFIRM ? 'btn--warning' : 'btn--primary');?>" data-id="<?=$order['id'];?>">
                            <?php if(isset($filter_status)): ?>
                                <i class="fas fa-plusfar fa-phone-volume"></i> <?=lang('order', 'txt_receive');?>
                            <?php else: ?>
                                <i class="far fa-phone-volume"></i> <?=lang('order', 'txt_callback');?>
                            <?php endif; ?>
                            </button>
                        <?php endif; ?>
                        </td>
                        ...
                        <td class="nowrap">
                        <?php if(isset($filter_status) && $user_call['id']): ?>
                        ...
                        <td class="nowrap">
                            <span class="badge <?=($order['status'] == Order::STATUS_PENDING_CONFIRM ? 'btn-outline-primary' : 'btn-outline-danger');?> btn-dim"><i class="fas fa-user"></i> <?=_echo($order['order_first_name']);?> <?=_echo($order['order_last_name']);?></span>
                        </td>
