        ...
        <?php endif; ?>
            ...
            <div class="form-control">
                <select id="filter-view" class="js-custom-select" name="<?=orderController::FILTER_VIEW;?>" >
                    ...
                    <option <?=($filter_view == orderController::VIEW_MEMBER ? 'selected' : null);?> value="<?=orderController::VIEW_MEMBER;?>"><?=lang('status', 'view_member');?></option>
                </select>
            </div>
    ...
    <?php if($list_statistics): ?>
        ...
        <div class="table-scroll">
            <table class="table-statistics table-sort">
                <thead>
                    <tr>
                    <?php if($filter_view == orderController::VIEW_MEMBER): ?>
                        <th></th>
                        <th class="sort-btn"><?=lang('label', 'member');?></th>
                    <?php else: ?>
                        <th class="sort-btn"><?=lang('label', 'time');?></th>
                    <?php endif; ?>
                ...
                ?>
                    <tr>
                    <?php if($filter_view == orderController::VIEW_MEMBER):
                        $user = User::get($statistics['user_id']);
                    ?>
                        <td>
                    ...
                    <?php endif; ?>
                        ...
                        <td class="nowrap align-center"><?=render_count($statistics['total_order']);?></td>
                        <td class="nowrap align-center"><?=render_count($statistics['total_pending_delivery'], 'text-warning');?></td>
                        <td class="nowrap align-center" role="status-delivered"><?=render_count($statistics['total_delivered'], 'text-success');?></td>
                        <td class="nowrap align-center" role="status-unreceived"><?=render_count($statistics['total_unreceived']);?></td>
                        <td class="nowrap align-center" role="status-returned"><?=render_count($statistics['total_returned'], 'text-danger');?></td>
                        <td class="nowrap align-center" role="status-agree-buy"><?=render_count($statistics['total_agree_buy']);?></td>
                        <td class="nowrap align-center" role="status-delivery-date"><?=render_count($statistics['total_delivery_date']);?></td>
                        <td class="nowrap align-center" role="status-delivering"><?=render_count($statistics['total_delivering']);?></td>
                    <?php if($filter_type != orderController::TYPE_SHIP): ?>
                        <td class="nowrap align-center" role="status-pending-confirm"><?=render_count($statistics['total_pending_confirm']);?></td>
                        <td class="nowrap align-center" role="status-calling"><?=render_count($statistics['total_calling']);?></td>
                        <td class="nowrap align-center" role="status-busy-callback"><?=render_count($statistics['total_busy_callback']);?></td>
                        <td class="nowrap align-center" role="status-can-not-call"><?=render_count($statistics['total_can_not_call']);?></td>
                        <td class="nowrap align-center" role="status-wrong-number"><?=render_count($statistics['total_wrong_number']);?></td>
                        <td class="nowrap align-center" role="status-refuse-buy"><?=render_count($statistics['total_refuse_buy']);?></td>
