...
<div class="box">
    ...
    <div class="box__header"><i class="fas fa-truck-loading text-warning"></i><span class="padding-x-2"><?=lang('system', 'order_pending_delivery');?></span></div>
    <div class="box__body">
    ...
    <?php if($list_order): ?>
            ...
            <table class="table-statistics table-sort">
                <thead>
                    <tr>
                        ...
                        <th><?=lang('label', 'status');?>/<?=lang('label', 'shipper');?></th>
                        <th></th>
        ...
        <?php 
            ...
            ?>
                    <tr>
                        ...
                        <?php if(Auth::$data['is_ban_team'] != Team::IS_BAN): ?>
                            <a class="btn btn--small btn--warning" href="<?=RouteMap::get('caller', ['block' => callerController::BLOCK_EDIT, 'action' => $order['id']]);?>">
                        ...
                        <td class="nowrap">
                            <span class="badge btn-outline-warning btn-dim"><i class="fas fa-user"></i> <?=_echo($order['order_first_name']);?> <?=_echo($order['order_last_name']);?></span>
                        </td>
            ...
            <?php if($total_amount): ?>
                <tfoot>
                    <tr>
                        <th colspan="3" class="align-left"><?=lang('system', 'txt_total');?>:</th>
                        <th colspan="17" class="align-left"><span class="badge rounded-pill bg-warning">+<?=Currency::format($total_amount);?></span></th>
                    </tr>
                </tfoot>
            <?php endif; ?>
            </table>
