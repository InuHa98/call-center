...
<div class="box">
    ...
    <div class="box__header"><i class="fad fa-clone"></i><span class="padding-x-2"><?=lang('system', 'order_duplicate');?></span></div>
    <div class="box__body">
        ...
        <?php foreach($list_order as $order): ?>
                    <tr>
                        ...
                        <?php if(Auth::$data['is_ban_team'] != Team::IS_BAN): ?>
                            <a class="btn btn--small" href="<?=RouteMap::get('caller', ['block' => callerController::BLOCK_EDIT, 'action' => $order['id']]);?>">
                        ...
                        <td class="nowrap">
                            <span class="badge btn-outline-light btn-dim"><i class="fas fa-user"></i> <?=_echo($order['order_first_name']);?> <?=_echo($order['order_last_name']);?></span>
                        </td>
