...
<div class="box">
    ...
    <div class="box__header"><i class="fas fa-undo-alt text-danger"></i><span class="padding-x-2"><?=lang('system', 'order_returned');?></span></div>
    <div class="box__body">
            ...
            <div class="filter-bar">
                ...
                <div class="form-control">
                    <select id="filter-payment" class="js-custom-select" name="<?=orderController::FILTER_PAYMENT;?>" data-placeholder="<?=lang('placeholder', 'select_status');?>">
                        ...
                        <option <?=($filter_payment == Order::IS_PAYMENT_AND_DEDUCT ? 'selected' : null);?> value="<?=Order::IS_PAYMENT_AND_DEDUCT;?>">Đã khấu trừ</option>
                        <option <?=($filter_payment == Order::IS_PAYMENT ? 'selected' : null);?> value="<?=Order::IS_PAYMENT;?>">Chưa khấu trừ</option>
                    </select>
                </div>
            ...
            <table class="table-statistics table-sort">
                <thead>
                    <tr>
                        ...
                        <th></th>
                        <th class="sort-btn"><?=lang('label', 'deduct');?></th>
        ...
        <?php 
            ...
            ?>
                    <tr>
                        ...
                        <td class="nowrap">
                            <?php if($amount): ?>
                                <span class="badge rounded-pill bg-danger">-<?=Currency::format($amount);?></span>
                            <?php else :?>
                                <?=($is_payement ? '<span class="badge rounded-pill bg-primary">Dedcuted</span>' : null);?>
                            <?php endif; ?>
                        </td>
                        <td class="nowrap">
                        ...
                        <td class="nowrap">
                            <?=_echo($order['note_ship']);?>
                        </td>


                        <td class="nowrap">
                            <span class="badge btn-outline-danger btn-dim"><i class="fas fa-user"></i> <?=_echo($order['order_first_name']);?> <?=_echo($order['order_last_name']);?></span>
                        </td>
            ...
            <?php if($total_amount): ?>
                <tfoot>
                    <tr>
                        ...
                        <th colspan="19" class="align-left"><span class="badge rounded-pill bg-danger">-<?=Currency::format($total_amount);?></span></th>
                    </tr>
                </tfoot>
            <?php endif; ?>
            </table>
