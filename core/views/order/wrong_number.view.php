...
<div class="box">
    ...
    <div class="box__header"><i class="fas fa-phone-slash text-danger"></i><span class="padding-x-2"><?=lang('system', 'order_wrong_number');?></span></div>
    <div class="box__body">
        ...
        <?php foreach($list_order as $order): ?>
                    <tr>
                        ...
                        <?php if(Auth::$data['is_ban_team'] != Team::IS_BAN): ?>
                            <a class="btn btn--small btn--danger" href="<?=RouteMap::get('caller', ['block' => callerController::BLOCK_EDIT, 'action' => $order['id']]);?>">
