...
trait Block_wrong_number {
    private static function block_wrong_number($team, $action = null) {
        $success = null;
		$error = null;
		$title = lang('system', 'order_wrong_number');
		$current_route = 'order_wrong_number';
		...
		return View::render('order.wrong_number', compact(
			'title',
			'current_route',
			'success',
			'error',
