...
trait Block_can_not_call {
    private static function block_can_not_call($team, $action = null) {
        $success = null;
		$error = null;

		$title = lang('system', 'order_can_not_call');
		$current_route = 'order_can_not_call';
