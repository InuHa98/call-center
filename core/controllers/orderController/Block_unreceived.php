...
trait Block_unreceived {
    private static function block_unreceived($team, $action = null) {
        $success = null;
		$error = null;
		$title = lang('system', 'order_unreceived');
		$current_route = 'order_unreceived';
		...
		return View::render('order.unreceived', compact(
			'title',
			'current_route',
			'success',
			'error',
