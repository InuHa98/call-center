...
trait Block_pending_delivery {
    private static function block_pending_delivery($team, $action = null) {
        $success = null;
		$error = null;
		$title = lang('system', 'order_pending_delivery');
		$current_route = 'order_pending_delivery';
		...
		return View::render('order.pending_deivery', compact(
			'title',
			'current_route',
			'success',
			'error',
