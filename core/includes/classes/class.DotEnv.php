...
class DotEnv
{
    ...
    public const AUTO_BAN = 'AUTO_BAN';
    public const AUTO_BAN_ORDER_CHECK = 'AUTO_BAN_ORDER_CHECK';
    public const AUTO_BAN_RPO = 'AUTO_BAN_RPO';

	public const AUTO_BAN_MIN_ORDER = 10;
